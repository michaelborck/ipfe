...
class ProgressBar:
    def __init__(self, message=None, duration=0):
        self.duration = duration
        self.prog_bar = '[]'
        self.fill_char = '#'
        self.width = 40
        self.message = message  # Added 3 Oct 2012, M. Borck
        self.__update_amount(0)
        sys.stdout.flush()  # Added 3 Oct 2012, M. Borck

    def update_display(self, count):
        self.update_time(count)
        print self, "\r",
        sys.stdout.flush()  # Added 3 Oct 2012, M. Borck
    ...
    def __str__(self):
        return str(self.message + self.prog_bar)  # Added 3 Oct 2012, M. Borck
